...
struct EqualizerAUM1App: App {
    ...
    init() {
        ...
        let appModel = M1AppModel(
            ...
            pasteboard: M1SystemPasteboard(),
            audioLifecycleMonitor: M1SystemAudioLifecycleMonitor(),
            wavPicker: M1SystemWAVPicker.select,
            diagnosticsPresenter: M1SystemDiagnosticsPresenter.present,
            textCommandRouter: M1SystemTextCommandRouter()
        )
