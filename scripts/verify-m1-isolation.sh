...
contracts = {
  ...
  "EqualizerAUM1" => {
    ...
    sources: [
      ...
      "EqualizerAUM1/App/M1SystemAppAdapters.swift",
      ...
      "EqualizerAUM1/Audio/M1SystemAudioLifecycleOperations.swift",
    ...
    frameworks: ["libEqualizerAUM1Runtime.a", "System/Library/Frameworks/Accelerate.framework", "System/Library/Frameworks/CoreAudio.framework", "System/Library/Frameworks/AudioToolbox.framework"],
  ...
  "EqualizerAUM1RuntimeTests" => {
    ...
    sources: [
      ...
      "EqualizerAUM1/App/M1AppModel.swift",
      "EqualizerAUM1RuntimeTests/M1AppModelTests.swift",
      "EqualizerAUM1/Audio/M1SystemAudioLifecycleMonitor.swift",
      "EqualizerAUM1RuntimeTests/M1SystemAudioLifecycleMonitorTests.swift",
      "EqualizerAUM1RuntimeTests/M1EditingSessionTests.swift",
      "EqualizerAUM1RuntimeTests/M1EditingPerformanceTests.swift",
    ],
    phase_types: %w[PBXSourcesBuildPhase PBXFrameworksBuildPhase PBXResourcesBuildPhase],
    frameworks: ["System/Library/Frameworks/XCTest.framework", "libEqualizerAUM1Runtime.a", "System/Library/Frameworks/Accelerate.framework", "System/Library/Frameworks/CoreAudio.framework", "System/Library/Frameworks/AudioToolbox.framework"],
    dependencies: ["EqualizerAUM1Runtime"],
    bridging_header: "EqualizerAUM1/EqualizerAUM1-Bridging-Header.h",
    test_host: nil,
  },
